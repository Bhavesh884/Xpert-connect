    ...
    >
      <div className="w-full md:w-2/4 flex flex-row md:flex-col gap-4 h-full flex-wrap ">
        <div className="w-full h-2/5  flex flex-row gap-4 ">
          ...
          <div className="w-1/2 h-full  overflow-hidden">
            <img
              src={
                "https://play-lh.googleusercontent.com/jUgeaIjSbQ1COzumNIzexa3qXDo_zTmbDkWgcBExluXjYASOoae61H7b6hwc8xJDAw"
              }
              onClick={() => {
                if (location.pathname === "/services") {
                  setShimmer(true);
                  getServicesByQuery("python");
                  setCurrentPage(1);
                  setShimmer(false);
                } else {
                  navigate("/services");
              ...
              className="w-full h-full object-fill hover:cursor-pointer overflow-hidden rounded-lg"
            />
          </div>
        </div>
        <div className="w-full h-2/5  flex flex-row gap-4">
      ...
      <div className="w-full md:w-1/4  h-full  flex flex-row md:flex-col gap-4">
        <div className="w-full h-2/5  overflow-hidden">
          <img
            src={"https://cdn-icons-png.flaticon.com/512/7531/7531795.png"}
            onClick={() => {
              if (location.pathname === "/services") {
                setShimmer(true);
                getServicesByQuery("javascript");
                setCurrentPage(1);
                setShimmer(false);
              } else {
                navigate("/services");
        ...
        <div className="w-full md:h-1/5  overflow-hidden">
          <img
            src={
              "https://th.bing.com/th/id/OIP.VEcfgIhPqiU6j7-M2UpfyQHaEH?rs=1&pid=ImgDetMain"
            }
            onClick={() => {
              if (location.pathname === "/services") {
                setShimmer(true);
                getServicesByQuery("angular");
                setCurrentPage(1);
                setShimmer(false);
              } else {
                navigate("/services");
            ...
            className="w-full h-full object-fill hover:cursor-pointer overflow-hidden rounded-xl"
          />
        </div>
      </div>
      <div className="w-full md:w-1/4 h-full  flex flex-row md:flex-col gap-4">
        ...
        <div className="w-full h-2/5  overflow-hidden">
          <img
            src={
              "https://d3f1iyfxxz8i1e.cloudfront.net/courses/course_image/f0dc3aa17dd2.png"
            }
            onClick={() => {
              if (location.pathname === "/services") {
                setShimmer(true);
                getServicesByQuery("react");
                setCurrentPage(1);
                setShimmer(false);
              } else {
                navigate("/services");
